...
let wizard1 = new Wizard ("abc", 10, "xyz")
wizard1.castSpell();
console.log(wizard1)
...
//Code Here
let phone1 = new phone ('iphone', 'xs', 60, 'black', 800)
let phone2 = new phone ('iphon', 'xr', 80, 'blue', 900)
let phone3 = new phone ('ipho', 'xm', 100, 'red', 1000)
...
//Code Here
let myFirstVehicle = new vehicle (4, 'red', 3000)
...
//Code Here 
let myFirstMotorcycle = new motorCycle (3, 'black', 1000, 'abc', 'sk')
...
class boat extends vehicle {
  ...
  checkSeaWorthiness (){
   if (this.isSeaworthy)
  console.log(`The ${color} ${type} is seaworthy!`)
  else{
...
//Code Here
let myFirstBoat = new boat (20, 'green', 100, 'loo', 'sss', false)
